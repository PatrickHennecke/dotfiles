...
},i),k("div",{className:"text hint selectable"},"9.6.4.0"),k("div",{className:"text hint selectable"},x),k("div",{
...
OnAfterShow:function(){},OnBeforeHide:function(){},Focus:function(){},Dispose:function(){}};function n(){(0,i.TT)(m)(h.JS)}
...
newTab:!0,reuseExisting:!1},null)),l.ClosePopup()}}},65760:function(a,b,c){"use strict";c.d(b,{d:function(){return H}});c(92292)
...
c(78448)),q=c(80022),r=c(12072),s=c(23097),t=c(18939),u=c(47333),v=c(95697),w=c(12131),x=c(67793),y=c(60954),z=c(95239),A=c(54811),B=c(70346),C=c(31173),D=c(69893),E=c(78440),F=c(4153),G=c(12190)
;c(13117);async function H(a,b,c,H,I,J,K,L,M){const N=await async function(b){for(let d=0;d<10;d++){try{
return await a.CallBackgroundScript("GetApplicationData",null,b)}catch(c){}await(0,E.xy)(1e3)}throw D.XB}(null),O=await(0,
y.y)(a);let P=null;const Q=Object.assign(Object.assign({},O.commands),{ShowLoginUI:N.standalone?a=>(0,
F.TT)(P).ShowSALoginPage(a):a=>(0,F.TT)(P).ShowNMLoginPage(O.commands.ShowLoginUI,a)})
;return P=function(a,b,c,y,H,I,J,K,L,M,N,O){const P=b,Q=c,R=y;let S;const T=H,U=J,V=(0,u.au)(P.data,R),W=(0,
A.I9)(P.data,P.service,P.rfo,I,R),X=(0,z.BO)(y),Y=L,Z=M,aa=N,ab=O
;let ac,ad=!1,ae=!1,af=!1,ag=!1,ah=!1,ai=!0,aj=!1,ak=!0,al=!1,am=!1,an=null,ao=null,ap=null,aq=null,ar=!0;const as={Init:at,
UnInit:au,ShowUI:av,IsAccountCreationAllowed:aw,IsAccountCompanyAdmin:ax,GetLicenseInfoPresentation:ay,
GetUpgradeMessagesUIInfo:az,HaveActivePaidConsumerLicense:aA,GetUsageInfoListItems:aF,ShouldActivateFillUI:aG,
GetFillOptionsListForCurrentTab:aH,GetAutoFunctionsModesForCurrentTab:aI,BlockAutoFunctionsForCurrentTabDomain:aJ,
ShowBlockedAutoFillForCurrentPage:aK,GetCurrentTabUrl:aE,GetFoldersList:aM,GetAllIdentities:aL,SearchItemsInFolder:aN,
GetSearchEngines:aO,GetKeyboardShortcuts:aP,CopyTextToClipboardWithAutoClear:aQ,ShowInitialPage:aW,ShowMainPage:aV,
ClosePopup:aR,CloseNativeMenu:aS,SetPersistentPage:a3,GetPersistentPage:a4,ClearPersistentPage:a5,RestorePersistentPage:a6,
ShowNativeItemsList:a7,LoginItemAction:bc,SafenoteItemAction:bd,BookmarkItemAction:be,ShowSaveFormsPage:a8,
ShowAskForUpgradePage:a0,GetCommandsForMainDotsMenu:a9,IsNativeUIAvailable:aB,IsNativeApp:aC,GetPopupRect:bl,
GetPopupScreenRect:bm,GetPopupMonitorRect:bn,IsReportAnIssueSupported:aD,ShowSALoginPage:aX,ShowNMLoginPage:aY};return as
;async function at(){var b,c,d,e,f,g,h,i,j;au(),S=await T.GetPlatformOS(),(0,F.TT)(P.data).onDataChanged.Add(bh),
P.options.AddOnChangeListener(bi),R.storage.AddOnChangeListener(bj),R.onNotificationFromBackgroundScript.Add(bg),
ae=null!==(b=a.standalone)&&void 0!==b&&b,af=null!==(c=a.needNativeRfUpgrade)&&void 0!==c&&c,
ag=null!==(d=a.desktopAppIsUpdating)&&void 0!==d&&d,ah=null!==(e=a.desktopAppIsClosed)&&void 0!==e&&e,
ai=null!==(f=a.useNativeMenus)&&void 0!==f&&f,aj=null!==(g=a.isNativeApp)&&void 0!==g&&g,
ak=null!==(h=a.isReportAnIssueSupported)&&void 0!==h&&h,al=null!==(i=a.isBreachMonSupported)&&void 0!==i&&i,
am=null!==(j=a.setupAccountOnStartPage)&&void 0!==j&&j,
ac=(0,t.n)(),ac.Init(),window.matchMedia("(prefers-color-scheme: dark)").matches?ac.SetTheme("dark-theme"):ac.SetTheme("light-theme"),
ac.SetPlatformSpecificStyles(S),V.Init(),W.Init(),document.body.addEventListener("mousemove",bk,!1),
window.oncontextmenu=function(){return!1},ag||ah||(al&&(ap=(0,B.v)(R),await ap.Init(),aq=ap),await(0,u.sJ)(P.options,R,ae)),
ad=!0}function au(){ad&&(ap&&(ap.UnInit(),ap=null,aq=null),W.UnInit(),V.Init(),R.onNotificationFromBackgroundScript.Remove(bg),
(0,F.TT)(P.data).onDataChanged.Remove(bh),P.options.RemoveOnChangeListener(bi),R.storage.RemoveOnChangeListener(bj),
document.body.removeEventListener("mousemove",bk),window.oncontextmenu=null,ad=!1)}async function av(a){const b=await a4()
;return b?a6(b,a):aW(a)}async function aw(){if(ae)return!0;const a=await(0,F.TT)(P.policies).Get({SelfHostedServer:!1,
CustomEverywhereServiceLocation:""}),b=a.SelfHostedServer,c=a.CustomEverywhereServiceLocation;return!b&&!c}async function ax(){
return(await(0,F.TT)(P.options).Get({AccountCompanyAdmin:!1})).AccountCompanyAdmin}async function ay(){
return R.CallBackgroundScript("GetLicenseInfoPresentation",null,null)}async function az(a){
return R.CallBackgroundScript("GetUpgradeMessagesUIInfo",null,a)}async function aA(){
return R.CallBackgroundScript("HaveActivePaidConsumerLicense",null,null)}function aB(){return ai}function aC(){return aj}
function aD(){return ak}async function aE(a){return R.CallBackgroundScript("GetCurrentTabUrl",null,a)}async function aF(a,b,c){
return R.CallBackgroundScript("GetUsageInfoListItems",null,c,a,b)}async function aG(a){
return R.CallBackgroundScript("ShouldActivateFillUI",null,a)}async function aH(a){
return R.CallBackgroundScript("GetFillOptionsListForCurrentTab",null,a)}async function aI(a){
return R.CallBackgroundScript("GetAutoFunctionsModesForCurrentTab",null,a)}async function aJ(a,b,c){
return R.CallBackgroundScript("BlockAutoFunctionsForCurrentTabDomain",null,c,a,b)}async function aK(a){
return R.CallBackgroundScript("ShowBlockedAutoFillForCurrentPage",null,a)}async function aL(a){
return R.CallBackgroundScript("GetAllIdentities",null,a)}async function aM(a){
return R.CallBackgroundScript("GetFoldersList",null,a)}async function aN(a,b,c,d){
return R.CallBackgroundScript("SearchItemsInFolder",null,d,a,b,c)}async function aO(){
return R.CallBackgroundScript("GetSearchEngines",null,null)}async function aP(){
return R.CallBackgroundScript("GetKeyboardShortcuts",null,null)}async function aQ(a,b){return await Y.WriteText(a),
R.CallBackgroundScript("ClearTextInClipboardAfterDelay",null,null,a,b)}function aR(){window.close()}async function aS(){
if(aB())return R.CallBackgroundScript("CloseNativeMenu",null,null)}async function aT(a,b){
const c=await R.storage.GetValue("ServerUrl",x.s8)
...
const d=(0,k.Y)({viewApi:R,rfCompany:(0,F.TT)(P.enterprise),serverUrl:b,invitations:a});await ac.ShowViewAndWaitResult(d,!1,c)}
async function e(a,b,c){const d=(0,j.N)({requests:a,ea:(0,F.TT)(P.emergencyAccess),viewApi:R,serverUrl:b})
;await ac.ShowViewAndWaitResult(d,!1,c)}async function f(a,b,c){const d=(0,j.N)({invitations:a,ea:(0,F.TT)(P.emergencyAccess),
viewApi:R,serverUrl:b});await ac.ShowViewAndWaitResult(d,!1,c)}async function g(a,b,c){const d=(0,h.j)({folders:a,sharing:(0,
F.TT)(P.sharing),viewApi:R,serverUrl:b});await ac.ShowViewAndWaitResult(d,!1,c)}async function l(a,b,c){const d=(0,i.c)({
files:a,sharing:(0,F.TT)(P.sharing),viewApi:R,serverUrl:b});await ac.ShowViewAndWaitResult(d,!1,c)}}async function aU(a,b){
const c=(0,l.U)(a,R);return ac.ShowViewAndWaitResult(c,!1,b)}async function aV(){const a=(0,d.H)({app:as,viewNavigator:ac,
service:P.service,data:P.data,dataItemDisplayNameProvider:V,initialIdentityProvider:W,usageInfo:P.usageInfo,commands:Q,
securityWarningsManager:P.securityWarningsManager,sharing:P.sharing,passwordsHistory:P.passwordsHistory,breachMon:aq,
options:P.options,settings:P.settings,policies:P.policies,view:R,extensionInfo:U,os:await T.GetPlatformOS(),clipboard:Y,
screenshot:Z,http:aa,rng:ab,canUseWin32LoginsAndBookmarks:!ae&&"win"===S});return ac.ShowView(a,!1)}async function aW(a){
if(af)return ac.ShowView((0,n.cB)(R,(()=>{(0,E.fI)(R.OpenUrl({newTab:!0,reuseExisting:!0,url:u.Ui},null)),as.ClosePopup()})),!1)
;if(ag||ah){const b=(0,e.A)();await ac.ShowView(b,!1)
;if(!await R.CallBackgroundScript("StartDesktopAppIfInstallationOrUpdateCompleted",null,a))return ag?ac.ShowView((0,s.J)({
localization:R}),!1):void aR();al&&(ap=(0,B.v)(R),await ap.Init(),aq=ap),await(0,u.sJ)(P.options,R,ae)}try{if(ae){
await bt(a)&&await bu(null,a);let f=!1;const g=P.service.GetGlobalStatus()
;if(!g.m_connected_to_server||!g.m_logged_in||!g.m_storage_connected){let g=null
;if(P.service.GetGlobalStatus().m_connected_to_server)try{await(0,E.mC)((async()=>P.service.Login({},a)),1e3,(()=>((0,
E.fI)(ac.ShowView((0,e.A)(),!0)),()=>{})))}catch(c){if((0,D.NR)(c))try{
await(0,q.V)(b,c.authInfo,null,bw(c.authInfo),R).Execute((0,E.f4)(null,null,null)),await a5(),await P.service.Login({},a),f=!0
}catch(d){await a5(),g=await aZ(a),f=!0}else if((0,w.tM)(c,15)){if(2===await a1())return a0(!1,a)}else(0,w.u7)(c)?(await bf(),
aR()):(g=await aZ(a),f=!0)}else g=await aZ(a),f=!0;const h=await a1();if(2===h)return a0(!1,a);if(0===h){
await bt(a)&&await bu(g,a)}}const h=await a1();if(2===h)return a0(!1,a);if(0===h){const b=await P.service.GetSyncPendingItems(a)
;await aT(b,a)}const i=await br(a);if(i.length>0){const b=await aU(i,a);if(0===b)await bs(i,a);else if(1===b){const b=(0,e.A)()
;await ac.ShowView(b,!1),await bo(a)}}if(f&&await bf(),0===h){const b=await bp();b&&await bv(b,a)}}else{
const b=P.service.GetGlobalStatus();b.m_connected_to_server&&b.m_logged_in&&b.m_storage_connected||await Q.ShowLoginUI(a)
;if(2===await a1())return a0(!1,a)}}catch(c){if(!(0,w.tM)(15))throw c;if(2===await a1())return a0(!1,a)}return void await aV()}
async function aX(a){await aZ(null!=a?a:(0,E.f4)(null,null,null))}async function aY(a,b){const c=(0,e.A)()
;return await ac.ShowView(c,!1),(0,E.W0)((async(b,c,d)=>{P.data.onDataChanged.Add(e);try{await a(d)}catch(f){
P.data.onDataChanged.Remove(e)}function e(a){let c=!1;for(const b of a){switch(b.event){case 2:case 3:case 1:c=!0}if(c)break}
if(c){const a=P.service.GetGlobalStatus();a.m_connected_to_server&&a.m_storage_connected&&a.m_logged_in&&((0,
F.TT)(P.data).onDataChanged.Remove(e),b())}}}),null!=b?b:(0,E.f4)(null,null,null))}async function aZ(a){var c
;if(P.service.GetGlobalStatus().m_connected_to_server){const d=await P.service.GetRFOnlineUserId();ar=!1
;const e=await P.rfo.GetLoginMethod(d.userId,a);if("sso"===e.type){const h=(0,g.Uf)("login-page",R,d.userId,null!==(c=(0,
u.sU)(d.serverUrl))&&void 0!==c?c:"",(0,u.ju)("Copyright (C) 1999-2024 Siber Systems Inc. All Rights Reserved."),{
async SSOLogin(c){a:for(;;)try{return void await X.LoginToAccountViaSSO(c,(0,F.TT)(e.sso),!1,a)}catch(d){if((0,D.NR)(d)){try{
await(0,q.V)(b,d.authInfo,null,bw(d.authInfo),R).Execute(a),await a5();continue a}catch(d){await a5(),
await ac.ShowViewAndWaitResult(f,!0,a)}return}if((0,w.tM)(d,15))return;if(!(0,w.u7)(d))throw d;await bf()}},
ChangeAccount:async()=>{await Q.ShowAccountSetupDialog({rfoServerUrl:d.serverUrl}),aR()}})
;return await ac.ShowViewAndWaitResult(h,!0,a),null}const f=(0,g.cx)("login-page",!0,(0,
u.ju)("Copyright (C) 1999-2024 Siber Systems Inc. All Rights Reserved."),!1,{GetAccountDisplayInfo:async()=>{var a;return{
userId:d.userId,serverTitle:null!==(a=(0,u.sU)(d.serverUrl))&&void 0!==a?a:""}},OnLogin:async(a,c)=>{try{await P.service.Login({
email:d.userId,password:a},c)}catch(e){if((0,D.NR)(e)){try{await(0,q.V)(b,e.authInfo,null,bw(e.authInfo),R).Execute((0,
E.f4)(null,null,null)),await a5(),await P.service.Login({email:d.userId,password:a},c)}catch(e){await a5(),
await ac.ShowViewAndWaitResult(f,!0,c)}return a}if((0,w.tM)(e,15))return a;if(!(0,w.u7)(e))throw e;await bf()}return a},
onForgotPassword:async()=>{await R.OpenUrl({newTab:!1,url:u.i0},null),aR()},
onChangeAccount:async()=>(await Q.ShowAccountSetupDialog({rfoServerUrl:d.serverUrl}),aR(),null)
},R,Y),h=await ac.ShowViewAndWaitResult(f,!0,a);return ar=!0,h}return await Q.OpenStartPage(null),aR(),null}
async function a0(a,b){const c=await(0,F.TT)(P.options).Get({AccountEnterprise:!1,AccountCompanyAdmin:!1,AccountLicenseTrial:!1,
...
;return!c.AccountEnterprise||c.AccountCompanyAdmin||c.AccountCanSwitchToFreeMode||c.AccountCanSetFreeDevice||c.AccountCanSetReadonlyDevice?ac.ShowViewAndWaitResult((0,
n.J_)(!0,a,c,R,{async Upgrade(a){await Q.OpenBuyLicensePage(a),as.ClosePopup()},async Renew(a){await Q.OpenRenewLicensePage(a),
as.ClosePopup()},async InstallDesktop(a){await Q.OpenSwitchToDesktopPage(a),as.ClosePopup()},async MakeThisDeviceFree(a){
await(0,F.TT)(P.rfo).UpdateUserDevices({devices:[{thisDevice:!0,freeDevice:!0}]},a),(0,E.fI)(Q.SyncInBackground(null))},
async MakeThisDeviceReadOnly(a){await(0,F.TT)(P.rfo).UpdateUserDevices({devices:[{thisDevice:!0,readOnly:!0}]},a),(0,
E.fI)(Q.SyncInBackground(null))},showError:null}),!1,b):ac.ShowViewAndWaitResult((0,n.sG)({showBackButton:a,viewApi:R}),!1,b)}
async function a1(){return(0,v.z)(await a2())}async function a2(){return(0,F.TT)(P.options).Get({AccountClientReadOnly:!1,
AccountClientBlocked:!1})}async function a3(a){return R.sessionStorage.Set({"persistent-popup-page":a})}async function a4(){
return(await R.sessionStorage.Get({"persistent-popup-page":null}))["persistent-popup-page"]}async function a5(){
return R.sessionStorage.Remove("persistent-popup-page")}async function a6(a,c){if("otp"===a.m_type){if(ar=!1,
!a.m_otp_data)return void await aW(c);const e=a.m_otp_data.m_otp_info,f=a.m_otp_data.m_otp_dialog_params;try{await(0,
q.V)(b,e,f,bw(e),R).Execute((0,E.f4)(null,null,null)),await a5(),await P.service.Login({},c)}catch(d){await a5(),await aZ(c)}
return ar=!0,aW(c)}throw(0,w.rb)(9,"Unknown page type: "+a.m_type)}async function a7(a,b){if(aB()){const c=bl(),d=bm(),e=bn()
;2===b?await R.CallBackgroundScript("ShowNativeBookmarksList",null,null,(0,
G.gv)(a),c,d,e):7===b?await R.CallBackgroundScript("ShowNativeSafenotesList",null,null,(0,
G.gv)(a),c,d,e):5===b?await R.CallBackgroundScript("ShowNativeIdentitiesList",null,null,(0,
G.gv)(a),c,d,e):await R.CallBackgroundScript("ShowNativeLoginsList",null,null,(0,G.gv)(a),c,d,e)}else;}async function a8(a){
if(aB())return await Q.ShowSaveFormsDialog(null),aR(),1;{
const b=await R.CallBackgroundScript("CollectSaveFormsData",null,a),c=(0,f.wn)({view:R,service:P.service,dataStorage:P.data,
usageInfo:P.usageInfo,settings:P.settings,policies:P.policies,commands:Q,passwordHistory:P.passwordsHistory,data:b})
;return ac.ShowViewAndWaitResult(c,!0,a)}}async function a9(){const a=await P.policies.Get({NoSecurityCenter:!1,
DisableEmergencyAccess:!1,DisableSync:!1,NoPasscards:!1,NoBookmarks:!1,DisableCreateLogins:!1,DisableCreateBookmarks:!1,
SelfHostedServer:!1,DisableLogoff:!1}),b=await(0,F.TT)(P.options).Get({AccountEnterprise:!1,AccountEnterpriseLicenseActive:!1,
AccountCompanyAdmin:!1,AccountGroupManager:!1,AccountLicenseActive:!1,AccountLicenseTrial:!1,AccountClientBlocked:!1,
AccountClientReadOnly:!1}),c=0!==(0,v.z)(b)?await R.LocalizeString("Menu_BlockedItem_Upgrade"):void 0,d=[];d.push({
title:await R.LocalizeString("Cmd_Password_Generator_Flat"),imageClass:"command-generate-icon",blockedText:c,
onCommand:ba((async(a,b)=>{const c=(0,m.Ms)({view:R,options:P.options,settings:P.settings,passwordsHistory:P.passwordsHistory,
commands:Q,clipboard:Y,http:aa,rng:ab,isNativeApp:aj});await ac.ShowViewAndWaitResult(c,!0,b)}))}),d.push({
title:await R.LocalizeString("Cmd_Authenticator"),imageClass:"command-authenticator-icon",blockedText:c,
onCommand:ba((async(a,b)=>{await Q.OpenAuthenticator(null),aR()}))}),d.push({
title:await R.LocalizeString("Cmd_SharingCenter_Flat"),imageClass:"command-sharing-center-icon",blockedText:c,
onCommand:ba((async(a,b)=>{await Q.OpenSharingCenter({direction:"all-shared"}),aR()}))}),a.NoSecurityCenter||d.push({
title:await R.LocalizeString("Cmd_PasswordAuditRun_Key"),imageClass:"command-security-center-icon",blockedText:c,
onCommand:ba((async(a,b)=>{await Q.OpenSecurityCenter({view:"all"}),aR()}))}),a.DisableEmergencyAccess||d.push({
title:await R.LocalizeString("Cmd_EmergencyAccess_Key"),imageClass:"command-emergency-access-icon",blockedText:c,
onCommand:ba((async(a,b)=>{await Q.OpenEmergencyAccess({direction:"my-contacts"}),aR()}))}),aj&&d.push({
title:await R.LocalizeString("Cmd_OpenDesktopEditor"),imageClass:"command-desktop-editor-icon",onCommand:async(a,b)=>{
await Q.OpenDesktopEditor(b),aR()}}),d.push("separator"),!ae&&a.DisableSync||d.push({
title:await R.LocalizeString("Cmd_ToolBarSync"),imageClass:"command-sync-icon",hideMenuAfterExecution:!!ae,
onCommand:async(a,b)=>{if(!ae)return await Q.StartSyncWithUI({viewRect:bl(),screenRect:bm(),monitorRect:bn()},b),aR()
;a.UpdateIcon(null,"command-sync-icon sync-progress-action",null),a.UpdateText(await R.LocalizeString("RfSyncProgress_Syncing"))
;try{await bo(b)}catch(c){if((0,D.r5)(c,D.rS)||(0,D.r5)(c,D.JI))(0,E.fI)(async function(){ar=!1,await aZ(b),ar=!0
;const a=await a1();if(0!==a){await bt(b)&&await bu(null,b)}if(await bf(),0!==a){const a=await P.service.GetSyncPendingItems(b)
;await aT(a,b)}const c=await br(b);if(c.length>0){const a=await aU(c,b);if(0===a)await bs(c,b);else if(1===a){const a=(0,e.A)()
;await ac.ShowView(a,!1),await bo(b)}}await aV()}());else{if(!(0,w.tM)(c,15))throw c;(0,E.fI)(a0(!1,b))}}finally{
a.UpdateIcon(null,"command-sync-icon",null),a.UpdateText(await R.LocalizeString("Cmd_ToolBarSync"))}}}),d.push({
title:await R.LocalizeString("Cmd_Settings_Flat"),imageClass:"command-settings-icon",onCommand:async(a,b)=>{
await Q.OpenExtensionSettings({newTab:!0,reuseExisting:!0},b),aR()}
}),b.AccountEnterprise&&(b.AccountCompanyAdmin||b.AccountGroupManager)&&d.push({
title:await R.LocalizeString("Cmd_Sync_OpenAdminCenter"),imageClass:"command-admin-center-icon",blockedText:c,
onCommand:ba((async(a,b)=>{var c;const d=await(null===(c=P.enterprise)||void 0===c?void 0:c.GetCompanyInfo(b))
;return await Q.OpenAdminCenter({view:"dashboard",companyCreatedTime:null==d?void 0:d.createdTime},b),aR()}))}),d.push({
title:await R.LocalizeString("Cmd_RunImport_Flat"),imageClass:"command-import-icon",blockedText:c,onCommand:ba((async(a,b)=>{
await Q.ShowImportDialog(!1),aR()}))}),aj||d.push({title:await R.LocalizeString("Cmd_ScanQRCode_Key"),
imageClass:"command-qr-scan-icon",blockedText:c,onCommand:async(a,b)=>{const c=await Z.CaptureScreenshotForActiveTabAsDataUrl()
;if(!c)throw(0,
D.ZU)(D.V2,await R.LocalizeString("Cmd_ScanQRCode_CouldNotCaptureScreenShot",null,"Could not capture screenshot"))
;const d=await(0,C.zC)(c,null,b)
;if(!d)throw(0,D.ZU)(D.V2,await R.LocalizeString("Cmd_ScanQRCode_CouldNotCaptureScreenShot",null,"Could not capture screenshot"))
;await Q.ScanQRCode(d,null,b),aR()}});const f=S;ae?"win"!==f&&"mac"!==f||d.push({
title:await R.LocalizeString("SA_LimitedMode_LinkRF_Text"),imageClass:"command-install-icon",onCommand:async(a,b)=>{
await Q.OpenSwitchToDesktopPage(b),aR()}}):"win"===f&&d.push({title:await R.LocalizeString("Cmd_OpenDesktopEditor"),
imageClass:"command-desktop-editor-icon",onCommand:async(a,b)=>{await Q.OpenDesktopEditor(b),aR()}}),d.push("separator")
;const g=await bb();return d.push({title:await R.LocalizeString("Cmd_Help_Flat"),imageClass:"command-help-icon",type:"submenu",
submenu:g}),b.AccountEnterprise&&b.AccountEnterpriseLicenseActive||b.AccountLicenseActive&&!b.AccountLicenseTrial||d.push({
title:await R.LocalizeString("Cmd_License_BuyNow"),imageClass:"command-upgrade-icon",onCommand:async(a,b)=>{
await Q.OpenBuyLicensePage(b),aR()}}),b.AccountEnterprise||a.SelfHostedServer||d.push({
title:await R.LocalizeString("Cmd_RenewalRewards_Flat"),imageClass:"command-renewal-rewards-icon",onCommand:async(a,b)=>{
await Q.OpenRFOPage(null,u.Uq,{newTab:!0},b),aR()}}),a.DisableLogoff||d.push({title:await R.LocalizeString("Cmd_Logoff_Flat"),
imageClass:"command-logoff-icon",onCommand:async(a,b)=>{await P.service.Logoff(b),aR()}}),aj&&(d.push("separator"),d.push({
title:await R.LocalizeString("Mac_Menu_App_QuitRoboForm"),imageClass:"command-quit-icon",onCommand:async(a,b)=>{
await Q.QuitRoboForm(b),aR()}})),d}function ba(a){return async(b,c)=>{const d=await a1();return 0!==d?a0(1===d,c):a(b,c)}}
async function bb(){const a=await P.policies.Get({SelfHostedServer:!1}),b=[];b.push({
title:await R.LocalizeString("Cmd_Help_Manual_Key"),onCommand:async(a,b)=>{await R.OpenUrl({newTab:!0,reuseExisting:!1,url:(0,
u.nF)("manual",await H.GetPlatformOS())},b),aR()}}),b.push({title:await R.LocalizeString("Cmd_Help_FaqAll_Key"),
onCommand:async(a,b)=>{await R.OpenUrl({newTab:!0,reuseExisting:!1,url:u.qP},b),aR()}}),b.push({
title:await R.LocalizeString("Cmd_Help_HomePage_Key"),onCommand:async(a,b)=>{await R.OpenUrl({newTab:!0,reuseExisting:!1,
url:u.l$},b),aR()}}),b.push("separator"),b.push({title:await R.LocalizeString("Cmd_Help_ForgotPassword_Key"),
onCommand:async(a,b)=>{await R.OpenUrl({newTab:!1,url:u.i0},b),aR()}}),b.push("separator");let c=!1
;return a.SelfHostedServer||(b.push({title:await R.LocalizeString("Cmd_Help_ContactSupport_Key"),
onCommand:async(a,b)=>(await Q.ContactSupport({reportType:"ContactSupport"},b),aR())}),ak&&b.push({
title:await R.LocalizeString("Popup_ReportAnIssue_Command_Text"),onCommand:async(a,b)=>(await Q.ContactSupport({
reportType:"WebPage"},b),aR())}),c=!0),ae||"win"!==S||(b.push({
title:await R.LocalizeString("Cmd_Help_ProblemStepsRecorder_Key"),onCommand:async(a,b)=>(await Q.RunProblemStepsRecorder(),aR())
}),c=!0),c&&b.push("separator"),b.push({title:await R.LocalizeString("Cmd_About_Key"),onCommand:async(a,b)=>{const c=(0,o.j)({
viewApi:R,service:P.service,app:as});await ac.ShowViewAndWaitResult(c,!0,b)}}),b}async function bc(a,b,c){if(b){
const b=await P.data.GetInfo(a,0,null),d=await(0,F.TT)(P.policies).Get({DisableFillWithoutSubmit:!1}),e=await(0,
F.TT)(P.options).Get({MatchingPasscardsCausesSubmit:!0,FillEmptyFieldsOnlyPasscard:!1
}),f=c||e.MatchingPasscardsCausesSubmit||d.DisableFillWithoutSubmit||b.hidePasswords||!1;(0,E.fI)(Q.FillForms({path:a,
identity:!1,submit:f,fillEmptyFieldsOnly:e.FillEmptyFieldsOnlyPasscard},null))}else{const b=await(0,F.TT)(P.options).Get({
ToolbarOpensNewWindow:!0});(0,E.fI)(Q.GoFillSubmit({navigate:!0,path:a,submit:!0,newTab:b.ToolbarOpensNewWindow},null))}
return aR()}async function bd(a){return(0,E.fI)(Q.OpenFile(a,{mode:"edit"})),aR()}async function be(a){const b=await(0,
F.TT)(P.options).Get({ToolbarOpensNewWindow:!0});return(0,E.fI)(Q.GoTo(a,{newTab:b.ToolbarOpensNewWindow})),aR()}
async function bf(){
await P.options.GetValue("OpenStartPageOnLoginFromExtension",!0)&&await R.CallBackgroundScript("OpenStartPageOnLoginFromPopup",null,null)
}function bg(a,...b){if("ClosePopupToolbar"===a)aR()}function bh(a){for(const b of a)switch(b.event){case 10:case 11:
if(ar)return void aR()}}async function bi(a){var b,c;let d=!1;for(const e in a)switch(e){case"AccountClientReadOnly":
case"AccountClientBlocked":{const f=null!==(b=a[e].oldValue)&&void 0!==b&&b
;(null!==(c=a[e].newValue)&&void 0!==c&&c)!==f&&(d=!0)}}d&&(0,E.fI)(async function(){2===await a1()?await a0(!1,(0,
E.f4)(null,null,null)):await aW((0,E.f4)(null,null,null))}())}async function bj(a){
for(const b in a)if("UseNativeMenus"===b)ae||(ai=void 0===a[b].newValue||a[b].newValue)}function bk(a){
if(void 0!==a.screenX&&void 0!==a.screenY&&void 0!==a.clientX&&void 0!==a.clientY&&0!==a.screenX&&0!==a.screenY){
an=a.screenX-a.clientX,ao=a.screenY-a.clientY;{const a=window.screen.availTop
;window&&window.screen&&window.screen.height&&a&&window.devicePixelRatio&&(window.devicePixelRatio>1&&a>100&&a<500||a<-100&&a>-500)&&(ao-=a)
}}}function bl(){return(0,G.gv)(document.body.getBoundingClientRect())}function bm(){
if((null===an||null===ao)&&!ae&&"mac"===S&&top){
const a=void 0!==top.screenLeft?top.screenLeft:top.screenX,b=void 0!==top.screenTop?top.screenTop:top.screenY
;let c=(top.outerWidth-top.innerWidth)/2;0;const d=a+c,e=b+c,f=(0,G.gv)(document.body.getBoundingClientRect());return(0,
G.DS)(f,d,e)}if(null!==an&&null!==ao){const a=(0,G.gv)(document.body.getBoundingClientRect());return(0,G.DS)(a,an,ao)}}
function bn(){{const a=window.screen.availLeft;if(window&&window.screen&&a&&a>0&&void 0!==window.screen.availWidth){const b=bm()
;if(!b)return;const c=window.screen.width-a-window.screen.availWidth;return(0,G.DS)(b,c,0)}}}async function bo(a){ar=!1
;const b=await Q.SyncInBackground(a);if(!b)return;b.forceMasterPasswordChange&&await bu(null,a),await aT(b.pendingItems,a)
;const c=b.syncParts.filter((a=>!a.main&&3===a.syncStatus&&a.syncError));if(c.length>0){const b=await aU(c,a)
;if(0===b)await bs(c,a);else if(1===b){const b=(0,e.A)();await ac.ShowView(b,!1),await bo(a)}}}function bp(){
return R.CallBackgroundScript("GetPendingItemDuplicates",null,null)}function bq(){
return R.CallBackgroundScript("ClearPendingItemDuplicates",null,null)}function br(a){
return R.CallBackgroundScript("GetPendingSyncErrors",null,a)}function bs(a,b){
return R.CallBackgroundScript("ClearPendingSyncErrors",null,b,a)}function bt(a){
return R.CallBackgroundScript("ShouldForceMasterPasswordChange",null,a)}async function bu(a,b){const c=(0,r.Qj)("login-page",R)
;await ac.ShowViewAndWaitResult(c,!0,b);const d=await(0,A.dt)(P.policies),e=await P.service.GetRFOnlineUserId(),f=(0,
r.rm)("login-page",R,a,d,{IsPasswordCompromised:async(a,b)=>{if(!ap)return!1;const c=await ap.GetCachedUserDataBreaches({
password:a},null,b);return!(!c||0===c.length)&&c.some((a=>1===a.m_type))},WasNewMasterPasswordAlreadyUsed:async(a,b,c)=>{
if(!await P.options.GetValue("AccountEnterprise",!1))return!1;const d=await P.policies.GetValue("EnforceMPHistory",0)
;return 0!==d&&P.service.WasNewMasterPasswordAlreadyUsed(a,b,d,c)},OnChangeMasterPassword:async(a,b,c,d)=>{
await P.rfo.ChangeAccountPassword(a,b,c),await P.service.Login({email:e.userId,password:a},c),d(a)}
}),g=await ac.ShowViewAndWaitResult(f,!0,b),h=(0,r.Dn)("login-page",R,g,{OnDone:async(a,b)=>{b()}})
;await ac.ShowViewAndWaitResult(h,!0,b)}async function bv(a,b){
const c=(0,p.e)(R,P.data,a.m_change_event,a.m_duplicates,a.m_item_icon_url);await ac.ShowViewAndWaitResult(c,!1,b),await bq()}
function bw(a){return{ShowConnectingScreen:b,ShowOtpScreen:c,ShowError:d};function b(a,b,c){return(0,E.Mj)({
action:async(d,e,f)=>{f.onTaskCancel.Add((a=>{e(a)}));const h=(0,g.iM)("login-page",c,a,b,R);await ac.ShowView(h,!0)}})}
async function c(b,c){await a3({m_type:"otp",m_otp_data:{m_otp_info:a,m_otp_dialog_params:b}});const d=(0,
g.sf)(b,"login-page",R,{onContextMenu:null});return ac.ShowViewAndWaitResult(d,!0,c)}async function d(a,b,c){const d=(0,
g.QK)("login-page",a,b,R);return ac.ShowViewAndWaitResult(d,!0,c)}}}(N,O,Q,a,b,c,H,0,J,K,L,M),await P.Init(),P}},
...
void(0,g.TT)(p).focus())}function D(){(0,g.TT)(n)(i.JS)}function E(){(0,g.TT)(n)(i.JS)}function F(){return(0,
...
className:"header"},k("div",{className:"back-button",onclick:()=>h(j.JS),role:"button",ariaLabel:await o("Dialog_Label_Back")
}),k("div",{className:"title"},(0,g.XE)(n.path,!0,void 0))),n.sharedFolder&&!(0,g.fA)(n.path)?n.sharedGroup?function(){
return async a=>{const c=r(a);return[k("div",{className:"content"},k("div",{className:"warning"
},o("DeleteGroup_Confirmation",[(0,g.XE)(n.path,!0,void 0)])),null!==c?k("div",{className:"error-text"},(0,
d.Qo)(c)):null,k("div",{className:"flexy"}),k("div",{className:"footer"},k("input",{type:"button",
className:"normal-button regular-button",value:await o("Btn_No"),onclick:()=>h(j.JS)}),k("input",{type:"button",
className:"normal-button important-button",value:await o("Btn_Yes"),onclick:()=>v(b)})))]};async function b(b){s(null),
await m.DeleteSharedFolder(n.path,b),a(!1)}}():function(){const b=(0,f.lJ)(p,{},e)[0];return async c=>{const e=b(c),f=r(c)
...
f.lJ)(p,{},m)[0];return async a=>{const b=c(a),e=r(a);let f
...
g.TT)(o).innerText=(0,d.Qo)(a))}(0,g.TT)(l)()}()),y,s,w)}function u(){(0,g.TT)(m)(h.JS)}function v(){(0,g.TT)(m)(h.JS)}
function w(){return(0,g.TT)(r).classList.remove("hidden"),x}function x(){(0,g.TT)(r).classList.add("hidden")}function y(){
return B(p),B(q),(0,g.TT)(n).classList.add("disabled-state"),window.addEventListener("mousedown",A,!0),z}function z(){C(p),C(q),
(0,g.TT)(n).classList.remove("disabled-state"),window.removeEventListener("mousedown",A,!0)}function A(a){a.preventDefault(),
a.stopPropagation()}function B(a){(0,g.TT)(a).setAttribute("disabled","disabled")}function C(a){(0,
g.TT)(a).removeAttribute("disabled")}}},78448:function(a,b,c){"use strict";c.d(b,{e:function(){return n}})
...
;const bN=100,bO=100,bP=400;let bQ=null;const bR="undefined"!=typeof IntersectionObserver;let bS=null;const bT=(0,J.E5)(!1)
...
J.tG)();let c4=null,c5=null,c6=null,c7=null,c8=!0,c9="",da="",db="",dc="",dd="",de="",df="",dg="",dh="",di="",dj=[],dk="",dl=""
;const dm=(0,J.tG)(),dn=new Map,dp=new WeakSet;let dq=null;const dr=1e3,ds=1e3
...
dh=await ad.LocalizeString("Safenote_ClickToView_Tip"),di=await ad.LocalizeString("Bookmark_ClickToOpen_Tip"),
...
m_show_password_generator:!1}}(a),!cK)return;fp(),await async function(){c4||(c4=await(0,F.$)("pwd-dict.json",null,ai),(0,
q.Hq)((0,M.TT)(c4)));c5||c8||(c5=await(0,F.$)("pwd-gen-words.json",null,ai));if(c8){const a=(0,d.H5)(),b=await aa.Get({
PassGenCharNumber:a.m_length,PassGenExcludeSimilar:a.m_exclude_similar_chars,PassGenUseHexChars:a.m_hex_digits_only,
PassGenCheckUpper:a.m_include_upper_case_chars,PassGenCheckLower:a.m_include_lower_case_chars,
PassGenCheckNumber:a.m_include_digits,PassGenCheckSpecial:a.m_include_specific_chars,PassGenCharSet:a.m_specific_chars}),c={
m_length:b.PassGenCharNumber,m_include_digits:b.PassGenCheckNumber,m_include_upper_case_chars:b.PassGenCheckUpper,
...
M.TT)(c0).textContent=c7,gq();else try{await gp()}catch(b){await go(),await gp()}}(),gi(),
...
D.A8)(e):null,g=f?(0,C.GenerateOTPForAuthInfo)(f):void 0;if(e&&f&&g){let c,d;const h=P("div",{className:"totp-section",title:dl,
onclick:a=>{a.preventDefault(),a.stopPropagation(),(0,J.fI)((async()=>{const a=(0,C.GenerateOTPForAuthInfo)(f)
...
C.GenerateOTPForAuthInfo)(g.m_otp_auth_info)
;g.m_totp_code_el1.textContent=null!==(c=null==a?void 0:a.substring(0,3))&&void 0!==c?c:"",
...
onCommand:async(a,c)=>{const d=(0,C.GenerateOTPForKeyOrURI)(e);d&&(await b.CopyTextToClipboardWithAutoClear(d,120),
...
return await fO(a,e),await fP(a,e),e}(e);default:throw I.Lh}}function fL(a,b){return{url:a=(0,w.PH)(a,b),canGoTo:!!a&&(!(0,
...
await Y.AddPassword(b,null),dj=[...await Y.GetHistory(null)],(0,M.TT)(c0).textContent=b.m_password,c7=b.m_password,gq()}
function gq(){if(!c7)return void gz(c1);const a=(0,q.im)(c7,[],null);let b,c;a>75?(b=c9,c="strong"):a>50?(b=da,
...
className:"upgrade link",href:"#",onclick:()=>f2((async()=>{try{await V.OpenBuyLicensePage(null)}catch(a){if(!(0,
...
const e=await a.LocalizeString("AskConsentToCollectData_Title"),f=await a.LocalizeString("AskConsentToCollectData_SectionTitleStart_Text"),g=await a.LocalizeString("AskConsentToCollectData_PersonalDataSection_Text"),o=await a.LocalizeString("AskConsentToCollectData_TechnicalDataSection_Text"),v=await a.LocalizeString("AskConsentToCollectData_UrlsAndSearchTerms_Text"),w=await a.LocalizeString("AskConsentToCollectData_ActionsAndFilledInformation_Text"),x=await a.LocalizeString("AskConsentToCollectData_PersonalRejectionImpact_Text"),y=await a.LocalizeString("AskConsentToCollectData_TechnicalRejectionImpact_Text"),z=await a.LocalizeString("AskConsentToCollectData_Details_Text"),A=await a.LocalizeString("AskConsentToCollectData_PrivacyPolicy_Link_Text"),B=await a.LocalizeString("AskConsentToCollectData_ContinueButton_Text"),C=await a.LocalizeString("AskConsentToCollectData_YesSwitcher_Text"),D=await a.LocalizeString("AskConsentToCollectData_NoSwitcher_Text"),E=h("div",{
...
},g)),h("div",{className:"personal-data-description"},h("ul",null,h("li",{className:"urls-and-search-terms"},v)),h("div",{
className:"flexy-space"}),k=h(d.ij,{leftValue:C,rightValue:D,default:p?"left":"right",highlighted:"left",onSwitch:t})),h("div",{
className:"personal-data-reject-impact"},x)),h("div",{className:"data-section"},h("div",{className:"technical-section-title"
},f,h("div",{className:"technical-data-section-title"},o)),h("div",{className:"technical-data-description"},h("ul",null,h("li",{
className:"technical-data"},w)),h("div",{className:"flexy-space"}),l=h(d.ij,{leftValue:C,rightValue:D,default:q?"left":"right",
highlighted:"left",onSwitch:u})),h("div",{className:"technical-data-reject-impact"},y)),h("div",{className:"permissions-text"
},z,h("a",{href:"#",onclick:r},A),"."),m=h("input",{type:"button",value:B,className:"important-button normal-button",onclick:s
})),n=h("div",{className:"action-progress-overlay-circle size64 hidden"}));return i=b,E},OnAfterShow:function(){},
OnBeforeHide:function(){},Focus:function(){},Dispose:function(){}};function r(){(0,e.D$)((()=>f()),x,o,v)}function s(){const a={
m_have_consent_for_personal_data:p,m_have_consent_for_technical_data:q};x(),(0,g.TT)(i)(a)}function t(a){p="left"===a}
function u(a){q="left"===a}function v(){return(0,g.TT)(n).classList.remove("hidden"),w}function w(){(0,
...
g.TT)(j).classList.add("disabled-state"),window.addEventListener("mousedown",z,!0),y}function y(){(0,
g.TT)(m).removeAttribute("disabled"),(0,g.TT)(l).classList.remove("switcher-disabled"),(0,
g.TT)(k).classList.remove("switcher-disabled"),(0,g.TT)(j).classList.remove("disabled-state"),
window.removeEventListener("mousedown",z,!0)}function z(a){a.preventDefault(),a.stopPropagation()}}function j(a,b){const c=b
;let d=null,i=null,j=null,k=null;const l=1e3;return{Create:async function(b,c){
...
e.D$)((()=>c.UninstallExtension()),q,l,o)}function n(){q(),(0,g.TT)(d)(f.JS)}function o(){return(0,
...
a.stopPropagation()}}},18939:function(a,b,c){"use strict";c.d(b,{n:function(){return h}})
;var d=c(3566),e=c(31173),f=c(78440),g=c(4153);function h(){let a=!1,b=null,c=null,h=null,i=null;const j=new Map,k=(0,d.Eg)()
;return{Init:function(){l(),a=!0,document.body.appendChild(k)},UnInit:l,ShowView:async function(a,d){if(b===a)return;const e=(0,
g.TT)(document.getElementById("popup")),f=c||(0,g.TT)(document.getElementById("main")),h=j.get(a);let i;if(h)i=h.m_element,
j.delete(a);else{i=document.createElement("div"),i.id="main",i.style.display="none";const b=await a.Create();i.appendChild(b),
e.insertBefore((0,g.TT)(i),f)}null==b||b.OnBeforeHide(),f.style.display="none",(0,g.TT)(i).style.display="block",
d||e.removeChild(f);d&&b?j.set(b,{m_element:(0,g.TT)(c)}):(null==b||b.Dispose(),j.forEach(((a,b)=>{b.Dispose(),
a.m_element.remove()})),j.clear());document.body.classList.remove("body-initial-size"),b=a,c=(0,g.TT)(i),b.OnAfterShow(),
b.Focus()},ShowViewAndWaitResult:async function(a,d,e){if(b===a)return h;const i=(0,
g.TT)(document.getElementById("popup")),k=c||(0,g.TT)(document.getElementById("main")),l=j.get(a);if(l){const b=l.m_element
;return h=(0,g.TT)(l.m_result_promise),j.delete(a),m(b),h}{const b=document.createElement("div");return b.id="main",
b.style.display="none",i.insertBefore((0,g.TT)(b),k),h=(0,f.W0)((async(c,d,e)=>{let f=!1,h=!1,i=null
;const j=await a.Create((function(a){c(a)}),d);b.appendChild(j),m(b),f=!0,h&&c((0,g.TT)(i))}),e),h}function m(e){
null==b||b.OnBeforeHide(),k.style.display="none",(0,g.TT)(e).style.display="block",d||i.removeChild(k),d&&b?j.set(b,{
m_element:(0,g.TT)(c),m_result_promise:(0,g.TT)(h)}):(null==b||b.Dispose(),j.forEach(((a,b)=>{b.Dispose(),a.m_element.remove()
})),j.clear()),document.body.classList.remove("body-initial-size"),b=a,c=(0,g.TT)(e),b.OnAfterShow(),b.Focus()}},
SetTheme:function(a){if(i===a)return;i&&document.body.classList.remove(i);document.body.classList.add(a),i=a},
SetPlatformSpecificStyles:function(a){e.Pl.forEach((b=>{const c="platform-"+b
;b===a?document.body.classList.add(c):document.body.classList.remove(c)}))},ShowNotification:function(a,b,c){k.Show(a,b,c)}}
;function l(){a&&(b=null,c=null,i="light-theme",k.Hide(),k.remove(),j.forEach(((a,b)=>{b.Dispose(),a.m_element.remove()})),
j.clear(),a=!1)}}},42285:function(a,b,c){"use strict";c.d(b,{w:function(){return d}});c(13117);function d(){const a=chrome
