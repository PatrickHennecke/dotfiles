...
"use strict";(self.rf_vlu7ce9uien=self.rf_vlu7ce9uien||[]).push([[944],{45680:function(a,b,c){c.r(b),c.d(b,{
...
g._)((async a=>m("div",{className:"guide-step-welcome"},m("div",{className:"media-content",onclick:()=>a(9)}),m("div",{
...
onCancel:a=>a(1),onEscape:a=>a(1),onClickOutside:a=>a(4)}),(()=>(0,g._)((async a=>m("div",{className:"guide-step-auto-save"
...
onCancel:a=>a(1),onEscape:a=>a(1),onClickOutside:a=>a(4)}),(()=>(0,g._)((async d=>m("div",{className:"guide-step-import"
},await(0,h.M)(!1,c,(e=>{
...
onCancel:a=>a(1),onEscape:a=>a(1),onClickOutside:a=>a(4)}),(()=>(0,g._)((async b=>m("div",{className:"guide-step-manual-save"
...
g._)((async()=>m("iframe",{id:"youtube-iframe",className:"guide-video",
...
const c=a.localization.LocalizeString;return(0,g._)((async d=>{let e;const g=m("div",{className:"guide-step-pin-extension"
},m("div",{className:"media-content"}),m("div",{className:"text-content"},m("div",{className:"title"
