...
"use strict";!function(){const a="XVNJ7ZrmBiH4VVV1ZxZ3DA",b=`${a}-1`,c=`${a}-2`;try{
...
type:a.type}))),extensions:h.extensions,pubKeyCredParams:h.pubKeyCredParams,rp:{name:h.rp.name,id:h.rp.id},timeout:h.timeout,
user:{name:h.user.name,displayName:h.user.displayName,id:e(d(h.user.id))}}},origin:window.location.origin},j=await l({
call:"create",params:i,callbackId:k()},a.signal);if(!j)return null;const m=null===(c=j.result)||void 0===c?void 0:c.credential
...
getAuthenticatorData:()=>f(m.response.authenticatorData),getPublicKey:()=>f(m.response.publicKeyDER)},
...
;return l}}(),window.addEventListener("ich0-XVNJ7ZrmBiH4VVV1ZxZ3DA",(a=>{const b=a.detail
;(null==b?void 0:b.event)&&window.addEventListener("ich1-XVNJ7ZrmBiH4VVV1ZxZ3DA",(a=>{var c,d;const e=a.relatedTarget
...
const a=Element.prototype.attachShadow;let b=!1;const c=[];Object.defineProperty(Element.prototype,"attachShadow",{
value:function(e){const f=a.call(this,e);b?window.dispatchEvent(new MouseEvent(d,{relatedTarget:f})):c.push(f);return f},
configurable:!0,writable:!0});const d="XVNJ7ZrmBiH4VVV1ZxZ3DA-shadow-1"
;window.addEventListener("XVNJ7ZrmBiH4VVV1ZxZ3DA-shadow-0",(a=>{b=!0;for(const b of c)window.dispatchEvent(new MouseEvent(d,{
relatedTarget:b}));c.length=0}),{capture:!0,once:!0})}();